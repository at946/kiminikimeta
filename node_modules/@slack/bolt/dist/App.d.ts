...
import { Middleware, AnyMiddlewareArgs, SlackActionMiddlewareArgs, SlackCommandMiddlewareArgs, SlackEventMiddlewareArgs, SlackOptionsMiddlewareArgs, SlackViewMiddlewareArgs, SlackAction, OptionsSource, BlockAction, SlackViewAction, Receiver, ReceiverEvent } from './types';
...
export interface AppOptions {
    ...
    agent?: ExpressReceiverOptions['agent'];
    clientTls?: ExpressReceiverOptions['clientTls'];
...
export default class App {
    ...
    constructor({ signingSecret, endpoints, agent, clientTls, receiver, convoStore, token, botId, botUserId, authorize, logger, logLevel, ignoreSelf, clientOptions, }?: AppOptions);
    /**
