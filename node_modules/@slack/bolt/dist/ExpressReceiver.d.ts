...
export default class ExpressReceiver extends EventEmitter implements Receiver {
    ...
    private server;
    private axios;
    constructor({ signingSecret, logger, endpoints, agent, clientTls, }: ExpressReceiverOptions);
